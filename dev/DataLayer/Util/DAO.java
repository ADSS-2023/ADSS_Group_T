...
public class DAO {
    ...
    public <T extends DTO> ArrayList<T> findAll(String tableName, LinkedHashMap<String, Object> conditions, Class<T> dtoClass) throws SQLException {
        ArrayList<T> results = new ArrayList<>();
        String sql = "SELECT * FROM " + tableName + " WHERE ";

        ArrayList<String> conditionStrings = new ArrayList<>();
        for (String fieldName : conditions.keySet()) {
            conditionStrings.add(fieldName + " = ?");
        }
        sql += String.join(" AND ", conditionStrings);
    ...
    public <T extends DTO> ArrayList<T> findAllBetweenDates(String tableName, String fieldName, String fromDate, String toDate, Class<T> dtoClass) throws SQLException {
        ArrayList<T> results = new ArrayList<>();
        String sql = "SELECT * FROM " + tableName + " WHERE " + fieldName + " BETWEEN " + fromDate + " AND " + toDate;
    ...
    public <T extends DTO> LinkedList<T> findAllByLinkedList(String tableName, String fieldName, Object value, Class<T> dtoClass) throws SQLException {
